                            ...
                            <div className="card m-3 border-0">
                                <>{projects.map((project, i) => (
                                    <div className="container text-center project mb-5" key={i}>
                                        ...
                                        <span>
                                            <a href={project.githubLink} className="text-secondary cormorant-font" target="_blank">GitHub</a>
                                            <a href={project.deployLink} className="text-secondary cormorant-font" target="_blank">See It Online</a>
                                        </span>
                                    </div>
                                ))
                                }</>
